...
namespace msr
{
	namespace airlib
	{
		...
		private: // methods
			...
			{
				aileron_deflection_ = (30 * (M_PI / 180)) * controls_.at(0).getOutput().control_deflection;
				elevator_deflection_ = (25 * (M_PI / 180)) * controls_.at(1).getOutput().control_deflection;
				rudder_deflection_ = (20 * (M_PI / 180)) * controls_.at(3).getOutput().control_deflection;
