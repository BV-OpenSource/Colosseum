...
#include "SimModeWorldFixedWing.h"
...
void ASimModeWorldFixedWing::BeginPlay()
{
    Super::BeginPlay();
...
void ASimModeWorldFixedWing::EndPlay(const EEndPlayReason::Type EndPlayReason)
{
...
void ASimModeWorldFixedWing::setupClockSpeed()
{
...
std::unique_ptr<msr::airlib::ApiServerBase> ASimModeWorldFixedWing::createApiServer() const
{
#ifdef AIRLIB_NO_RPC
...
void ASimModeWorldFixedWing::getExistingVehiclePawns(TArray<AActor*>& pawns) const
{
...
std::string ASimModeWorldFixedWing::getVehiclePawnPathName(const AirSimSettings::VehicleSetting& vehicle_setting) const
{
...
PawnEvents* ASimModeWorldFixedWing::getVehiclePawnEvents(APawn* pawn) const
{
    return static_cast<TVehiclePawn*>(pawn)->getPawnEvents();
}
const common_utils::UniqueValueMap<std::string, APIPCamera*> ASimModeWorldFixedWing::getVehiclePawnCameras(
    APawn* pawn) const
{
    return (static_cast<const TVehiclePawn*>(pawn))->getCameras();
}
void ASimModeWorldFixedWing::initializeVehiclePawn(APawn* pawn)
{
    static_cast<TVehiclePawn*>(pawn)->initializeForBeginPlay();
}
std::unique_ptr<PawnSimApi> ASimModeWorldFixedWing::createVehicleSimApi(
...
msr::airlib::VehicleApiBase* ASimModeWorldFixedWing::getVehicleApi(const PawnSimApi::Params& pawn_sim_api_params,
    const PawnSimApi* sim_api) const
{
    const auto fixedwing_sim_api = static_cast<const FixedWingPawnSimApi*>(sim_api);
    return fixedwing_sim_api->getVehicleApi();
}